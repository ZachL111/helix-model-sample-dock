"""Regression checks for the helix-model-sample-dock casebook."""
...
from casebook.harness import assert_expected, helix_model_sample_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(helix_model_sample_dock_summary(), assert_expected())
